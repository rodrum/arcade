...
! dummy variables
integer :: idoy, isou, ista, ilin, isec, ilin2
integer :: OpenStatus
...
100 format (A28, I5.5, A1, I3.3, A1, I5.5, A1, I4.4, A4)
200 format (A22, I5.5, A1, I3.3, A1, I5.5, A1, I4.4, A4)
...
do ilin = 1, nrec
    ...
    write(nodes_in, 100) "../output/nodes/nodes_climt_",        &
    ...
    write(nodes_out, 100) "../output/nodes/descr_climt_",       &
                        isec, "_", idoy, "_", isou, "_", ista, ".txt"
    ...
    !=== ECMWF completion
    write(nodes_in, 100) "../output/nodes/nodes_ecmwf_", &
                            isec, "_", idoy, "_", isou, "_", ista, ".txt"
    write(*,*) "Reading ", trim(nodes_in)
    open (10, FILE=trim(nodes_in), STATUS="OLD", ACTION="read", &
        POSITION="rewind", IOSTAT=OpenStatus)
    ...
    write(ecmwf_in, 200) "../output/ecmwf/ecmwf_",      & 
                            isec, "_", idoy, "_", isou, "_", ista, ".dat"
    ...
    write(nodes_out, 100) "../output/nodes/descr_ecmwf_",   &
                            isec, "_", idoy, "_", isou, "_", ista, ".txt"
